...
from Missing_data_handling import handling_missing_values
from variable_transmission import Var_Transforamtion
from outlier import outlier
from Fs import filter_method
...
class TELCO_CUSROMER_CHURN:
    ...
    def feature_scaling(self):
        try:
            ...
            logger.info(f"==================saving the scaled nad logistic regression model into pickle file=======")
    ...
    def hyper_tuning(self):
        try:
            ...
            self.best_model_tuned, self.best_params = hyper_parameter(
...
if __name__=='__main__':
    obj =TELCO_CUSROMER_CHURN('WA_Fn-UseC_-Telco-Customer-Churn.csv')
    obj.missing_values()
    obj.data_seperation()
